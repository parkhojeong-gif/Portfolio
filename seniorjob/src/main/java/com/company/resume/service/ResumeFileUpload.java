...
@WebServlet("/ResumeFileUpload") // --ResumeFileUpload--
@MultipartConfig(maxFileSize = -1, maxRequestSize = -1, fileSizeThreshold = 1024)
public class ResumeFileUpload extends HttpServlet {
...
//		String ATTACHES_DIR = request.getContextPath() + "/img";
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("resumeInsert");

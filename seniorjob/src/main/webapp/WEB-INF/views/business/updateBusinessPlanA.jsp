...
<body>
			...
			<div class="row">
				<div class="col-md-8 col-md-offset-2">
					...
					<form action="updateBusinessPlanA" method="post" name="frm">
						<input type="hidden" name="seq" value="${bp.seq}">
						<div class="row">

							<div class="col-sm-12">
								<div class="form-group">
									<label for="business_a">사업의 배경과 필요성</label>
									<textarea name="business_a" id="business_a" class="form-control">${bp.business_a}</textarea>
								</div>
							</div>
							...
							<div class="col-sm-12">
								<div class="form-group">
									...
									<textarea name="business_b" id="business_b" class="form-control">${bp.business_b}</textarea>
								</div>
							</div>
							...
							<div class="col-sm-12">
								<div class="form-group">
									...
									<textarea name="business_c" id="business_c" class="form-control">${bp.business_c}</textarea>
								</div>
							</div>
				...
				<div class="col-md-8 col-md-offset-2">
					...
					<form>
						<div class="row">
							...
							<div class="col-sm-12">
								<div class="form-group">
									<label for="business_a">제품(서비스)명</label>
							...
							<div class="col-sm-12">
								<div class="form-group">
									<label for="business_a">제품(서비스)소개</label>
									<textarea id="business_a" class="form-control"></textarea>
								</div>
							</div>
							...
							<div class="col-sm-12">
								<div class="form-group">
									<label for="business_a">제품(서비스)차별성</label>
									<textarea id="business_a" class="form-control"></textarea>
								</div>
							</div>
				...
				<div class="col-md-8 col-md-offset-2">
					...
					<form>
						<div class="row">
							...
							<div class="col-sm-12">
								<div class="form-group">
									<label for="business_a">국내외 목표시장</label>
									<textarea id="business_a" class="form-control"></textarea>
								</div>
							</div>
							...
							<div class="col-sm-12">
								<div class="form-group">
									<label for="business_a">국내외 관련기술(제품) 동향</label>
									<textarea id="business_a" class="form-control"></textarea>
								</div>
							</div>
							...
							<div class="col-sm-12">
								<div class="form-group">
									<label for="business_a">경쟁사 현황</label>
									<textarea id="business_a" class="form-control"></textarea>
								</div>
							</div>
							...
							<div class="col-sm-12">
								<div class="form-group">
									<label for="business_a">시장창출 가능성</label>
									<textarea id="business_a" class="form-control"></textarea>
								</div>
							</div>
				...
				<div class="col-md-8 col-md-offset-2">
					...
					<form>
						<div class="row">
							...
							<div class="col-sm-12">
								<div class="form-group">
									<label for="business_a">제품홍보방법</label>
									<textarea id="business_a" class="form-control"></textarea>
								</div>
							</div>
							...
							<div class="col-sm-12">
								<div class="form-group">
									<label for="business_a">수익창출방안</label>
									<textarea id="business_a" class="form-control"></textarea>
								</div>
							</div>
							...
							<div class="col-sm-12">
								<div class="form-group">
									<label for="business_a">시장성공요인</label>
									<textarea id="business_a" class="form-control"></textarea>
								</div>
							</div>
	...
	<div id="nudge_wrap" style="transform: translateX(42px);">
		<div class="inner">
			...
			<div class="area_btn col-sm-12 text-center">
				<button type="submit" class="btn btn-primary">중간저장</button>
			</div>

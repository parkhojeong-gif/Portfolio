...
function pagePre() {
	...
	location.href="getService_CenterQna2?seq=${num.prev }";
	}
	}
function pageNext() {
	...
	location.href="getService_CenterQna2?seq=${num.next }";
	}
	}
$(function(){
	$("#btnUpd").on("click", function(){
		//location.href ="updateEmp?employee_id=${emp.employee_id}"
		location.assign("updateService_CenterFormQna2?seq=${gongji.seq}");
...
<!--       추후 중분류 활용하여 이벤트 상태 표시                      <div class="property-meta entry-meta clearfix ">   
                            ...
                            <div class="button navbar-right">
                        		...
                        		<button class="navbar-btn nav-button wow fadeInRight animated" onclick="location.href='deleteService_CenterQna2?seq=${gongji.seq}'" data-wow-delay="0.48s" style="visibility: visible; animation-delay: 0.48s; animation-name: fadeInRight;">삭제</button>
                    		</div>
                    		<br><br><br><br><br><br>
                              <!-- 수정/삭제-->
                            </div>

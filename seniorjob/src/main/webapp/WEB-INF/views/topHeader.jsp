            ...
            <div class="container">
               ...
               <c:otherwise>
                    ...
                    <ul class="main-nav nav navbar-nav navbar-right">
                        <li class="wow fadeInDown" data-wow-delay="0.3s"><a class="" href=getMentorList>멘토</a></li>
                        <li class="wow fadeInDown" data-wow-delay="0.2s"><a class="" href="getMentoringList">멘토링</a></li>

            ...
            <div class="container">
                <div class="row">
                    <div class="page-head-content">
                        <h1 class="page-title">${list.UsersVO.name}멘토님의 정보 조회</h1>               
                    </div>
                </div>
            </div>
        </div>
			...
			<div class="box-two proerty-item">
				<div class="item-thumb">
					<a href="property-1.html"><img
						src="../resources/assets/img/mentor/photoDefault.jpg"></a>
				</div>
				...
				<div class="item-entry overflow">
					...
					<span class="pull-left"><b>${mentor.mentor_introduce }</b></span>
				</div>
			</div>
		</div>
	</c:forEach>

...
<div class="center">
  ...
  <div class="card green">
    <div class="additional">
      ...
      <div class="more-info">
        ...
        <div class="coords">
          <span>회사명: ${list.mentor_company_name }</span>
          <span>부서명: ${list.mentor_department_name }</span>
        </div>
        <div class="stats">
          <div>
  ...
  <input class="button btn largesearch-btn" value="메인 페이지로 이동" type="button" onclick="location.href='getMain'">
  <input class="button btn largesearch-btn" value="마이 페이지로 이동" type="button" onclick="location.href=''">
